 ...
 */
public class WeissTurm extends figur {
    private String bezeichnung = "wT";
    ...
    /**
     * Instantiates a new Weiss turm.
     *
     * @param yPos the y pos
     * @param xPos the x pos
     */
    public WeissTurm(int yPos, int xPos) {
        if (cnt <= 2){
            bezeichnung += cnt + 1;
            WeissTurm.xPos[cnt] = xPos;
            WeissTurm.yPos[cnt] = yPos;
            cnt++;
        } else {
